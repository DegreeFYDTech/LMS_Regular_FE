...
const PaymentDashboard = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://lms-regular.degreefyd.com/v1/payment/cgc-reports`,
        {
          params,
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "email",
      render: (text, record) =>
        record.student ? record.student.student_email : record.email || "N/A",
      width: 200,
    },
    {
      title: "Phone",
      ...
      key: "phone",
      render: (text, record) =>
        record.student ? record.student.student_phone : record.phone || "N/A",
      width: 130,
    },
    {
      title: "College",
