...
const CounsellorBreakDashboard = lazy(
  () => import("../pages/counsellor_break_activities"),
);
const NotFoundPage = lazy(
  () => import("../components/404 Page Not Found/Main"),
);
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute />}>
            <Route element={<MainLayout />}>
              ...
              <Route
                path="/college-brochure/:universityName"
                element={<CollegeBrochure />}
              />
